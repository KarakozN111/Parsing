...
category_pages = {
     'https://halykmarket.kz/category/tehnika-dlya-doma?sort=popular-desc&f=brands%3ALG%3Abrands%3ASamsung': 45,
    'https://halykmarket.kz/category/noutbuki-i-kompyuteri?sort=popular-desc&f=brands%3ASamsung%3Abrands%3ALG': 37,
    'https://halykmarket.kz/category/kuhonnaya-tehnika?sort=popular-desc&f=brands%3ALG%3Abrands%3ASamsung': 32,
    'https://halykmarket.kz/category/televizori-i-audiotehnika?sort=popular-desc&f=brands%3ALG%3Abrands%3ASamsung': 56
}
...
df = pd.DataFrame(products_data, columns=["Item", "Seller", "Price", "Link", "Category", "Brand"])
...
for _, row in df.iterrows():
    cursor.execute("""
        INSERT INTO lg_products (name, seller, price, link, category, brand, parsed_date)
        VALUES (?, ?, ?, ?, ?, ?, ?)
    """, (
        row["Item"],
        row["Seller"],
